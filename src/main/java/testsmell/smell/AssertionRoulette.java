        ...
        public void visit(MethodDeclaration n, Void arg) {
            if (Util.isTestMethod(n)) {
                ...
                /*
                    ...
                    Small improvement to only mark the test as smelly if there is more than 1 assertion and more than one assertion with no message
                 */
                else if (assertNoMessageCount > 1 && assertCount > 1) //if there is more than one assert statement, then all the asserts need to have an explanation message
